...
public class ArrayQueueModule {
    ...
    private static int inBounds(int index) {
        int bounds = data.length;
        return ((head + index % bounds) + bounds) % bounds;
    }
